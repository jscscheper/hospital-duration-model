...
tableMissingValues['payer_code', 2]
...
### Naïve Bayes
We will look at the outcome regarding Naïve Bayes first. The confusion matrix is shown in table [NUMBER]. When analyzing a confusion matrix it is essential know that the (longest) diagonal line represents all true predictions.
...
### Simple Logistics
Next up is the confusion matrix retrieved from the Simple Logistics classifier, which is depicted in table [NUMBER].
